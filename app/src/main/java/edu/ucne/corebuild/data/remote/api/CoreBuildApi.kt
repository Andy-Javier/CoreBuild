...
interface CoreBuildApi {
    ...
    @PUT("Cpu/{id}")
    suspend fun updateCpu(@Path("id") id: Int, @Body dto: CpuDto): Response<CpuDto>
    ...
    @PUT("Gpu/{id}")
    suspend fun updateGpu(@Path("id") id: Int, @Body dto: GpuDto): Response<GpuDto>
    ...
    @PUT("Motherboard/{id}")
    suspend fun updateMotherboard(@Path("id") id: Int, @Body dto: MotherboardDto): Response<MotherboardDto>
    ...
    @PUT("Ram/{id}")
    suspend fun updateRam(@Path("id") id: Int, @Body dto: RamDto): Response<RamDto>
    ...
    @PUT("Psu/{id}")
    suspend fun updatePsu(@Path("id") id: Int, @Body dto: PsuDto): Response<PsuDto>
